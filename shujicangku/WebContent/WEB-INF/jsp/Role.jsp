                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="role/roleUpdate" method="post" onsubmit="return check();">
                                                <table width="100%"class="cont">
                                                	<input type="hidden" name="id" value="${role['id'] }"/>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">标题：</td>
                                                        <td width="25%"><input type="text" name="title" id="title" value="${role['title'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">名称：</td>
                                                        <td width="25%"><input type="text" name="name" id="name" value="${role['name'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">备注：</td>
                                                        <td width="25%"><textarea name="remark" id="remark">${role['remark'] }</textarea></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <c:forEach items="${function }" var="function" varStatus="vs">
	                                                    <tr>
	                                                        <td width="2%">&nbsp;</td>
	                                                        <td width="15%"><input type="checkbox" value="${function['id'] }" id="${vs.count }" name="functionId"></td>
	                                                        <c:forEach items="${functionRole }" var="functionR">
	                                                        	<c:if test="${functionR['functionInfo']['id'] eq function['id']  }" var="s1">
	                                                        		<script type="text/javascript">
	                                                        		$("#"+${vs.count}).attr("checked","checked");
	                                                        		</script>
	                                                        	</c:if>
	                                                        </c:forEach>
	                                                        <td width="25%">${function['title'] }</td>
	                                                        <td width="2%">&nbsp;</td>
	                                                    </tr>
                                                    </c:forEach>
                                                     <tr>
                                                        <td colspan="4"><input type="submit" value="修改角色"></td>
                                                    </tr>
