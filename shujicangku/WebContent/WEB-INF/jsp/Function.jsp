            ...
            <tr>
                ...
                <td valign="top" background="image/image/background/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="image/image/background/content_bg.gif">
                        <tr><td height="31"><div class="title">修改权限</div></td></tr>
                    </table>
                </td>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">修改权限</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="function/functionUpdate" method="post" onsubmit="return check();">
                                            <input type="hidden" value="${function['id'] }" name="id">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">标题：</td>
                                                        <td width="25%"><input type="text" name="title" id="title" value="${function['title'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">名称：</td>
                                                        <td width="25%"><input type="text" name="name" id="name" value="${function['name'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">地址：</td>
                                                        <td width="25%"><input type="text" name="url" id="url" value="${function['url'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">备注：</td>
                                                        <td width="25%"><textarea name="remark" id="remark"><c:out value="${function['remark'] }"></c:out></textarea></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                     <tr>
                                                        <td colspan="4"><input type="submit" value="修改权限"></td>
                                                    </tr>
