                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="book/informationUpdate" method="post" onsubmit="return check();" enctype ="multipart/form-data">
                                                ...
                                                <table width="100%"class="cont">
                                                        ...
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">书籍名称：</td>
                                                        <td width="25%"><input type="text" name="name" id="name" value="${book['name'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">书籍单价：</td>
                                                        <td width="25%"><input type="text" name="price" id="price" value="${book['price'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">书籍语种：</td>
                                                        <td width="25%"><input type="text" name="language" id="language" value="${book['language'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        ...
                                                        <td width="25%">
                                                        	...
                                                        	<select name="b_id" id="b_id">
                                                        		<c:forEach items="${businessList }" var="business">
                                                        			<c:if test="${business['id'] eq book['business']['id']}" var="s1">
