            ...
            <tr>
                ...
                <td valign="top" background="image/image/background/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="image/image/background/content_bg.gif">
                        <tr><td height="31"><div class="title">权限管理</div></td></tr>
                    </table>
                </td>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width="2%">&nbsp;</td>
                            <td width="96%">
                        <a href="request/functionAdd">添加</a>
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="sys/user" method="">
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <c:forEach items="${pager.datas }" var="function" varStatus="vs">
	                                                    <tr align="center" class="d">
	                                                        <td>${function['title'] }</td>
	                                                        <td>${function['name'] }</td>
	                                                        <td>${function['url'] }</td>
	                                                        <td>${function['remark'] }</td>
	                                                        <td><a href="function/queryOne?id=${function['id'] }">编辑</a> <a href="function/functionDelete?id=${function['id'] }" onclick="window.confirm('您确认删除该权限吗?')">删除</a></td>
	                                                    </tr>
                                                    </c:forEach>
                                                     <tr>
	                                                    <td>
		                                                    <c:if test="${pager.pageNow gt 1}">
											                <a href="function/queryAll?pageNow=${pager.pageNow-1 }">上一页</a>
											                </c:if>
											                <c:if test="${pager.pageNow lt pager.totalPage}">
											                <a href="function/queryAll?pageNow=${pager.pageNow+1 }">下一页</a>
											                </c:if>
	                                                    </td>
                                                    </tr>
                                                </table>
