                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="book/informationAdd" method="post" onsubmit="return check();" enctype ="multipart/form-data">
                                                <table width="100%"class="cont">
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">书籍单价：</td>
                                                        <td width="25%"><input type="text" name="price" id="price"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">书籍语种：</td>
                                                        <td width="25%"><input type="text" name="language" id="language"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
