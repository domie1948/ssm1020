                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="business/informationUpdate" method="post" onsubmit="return check();" enctype ="multipart/form-data">
                                                ...
                                                <table width="100%"class="cont">
                                                        ...
                                                        <td width="25%"><input type="text" name="name" id="name" value="${business['name'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">供应商地址：</td>
                                                        <td width="25%"><input type="text" name="address" id="address" value="${business['address'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">供应商电话：</td>
                                                        <td width="25%"><input type="text" name="phone" id="phone" value="${business['phone'] }"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
