            ...
            <tr>
                ...
                <td valign="top" background="image/image/background/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="image/image/background/content_bg.gif">
                        <tr><td height="31"><div class="title">添加用户</div></td></tr>
                    </table>
                </td>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">添加用户</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="user/sign" method="post" onsubmit="return check();">
                                            <input type="hidden" value="${user['id'] }" name="id">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">登录名：</td>
                                                        <td width="25%"><input type="text" name="loginName" id="loginName"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">姓名：</td>
                                                        <td width="25%"><input type="text" name="userName" id="userName"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">电话：</td>
                                                        <td width="25%"><input type="text" name="phoneNo" id="phoneNo"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">备注：</td>
                                                        <td width="25%"><textarea name="remark" id="remark"></textarea></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                     <tr>
                                                     		<input type="hidden" name="roleId" value="2"/>
                                                        <td colspan="4"><input type="submit" value="注册"></td>
                                                    </tr>
